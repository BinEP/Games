...
public class ChatRoomWindow extends JFrame {
    ...
    public void newChat(String host) {
	...
	// you can javadoc fields just like you would methods!
	/** For entering messages to be sent to the chat room */ 
    ...
    private void addToTranscript(String message) {
        ...
        /*
         * Your kludge really isn't bad, but for something fancier you could try
         * scrollPane.getVerticalScrollBar().setValue(scrollPane.getVerticalScrollBar().getMaximum())
         * or just add a listener which sets the caret position so you don't have to worry
         * about calling it manually everytime you call append.
         */
    }
    ...
    private class ActionHandler implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
            ...
            if (src == quitButton) {  // Disconnect from the server and end the program.
            	...
            	// commenting code is definitely a good thing, but when your inline comments
            	// get as big as below, it's a sign that you should probably pull out a method
            	// and document that.
