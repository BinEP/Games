...
/*
 * Rather than having two nearly-identical classes, I'd create a abstract CardGame  class
 * and define any methods which compare card values there so they can be overridden
 * by particular games.
 */
