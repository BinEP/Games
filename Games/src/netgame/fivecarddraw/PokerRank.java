...
public class PokerRank {
   ...
   */
    public static void main(String[] args) {
        ...
        // converting Card into an enum and using that would make all this a *lot* more readable
    ...
    /* 
     * try creating an enum for these instead. It makes the code easier to read
     * and prevents anyone from passing in invalid numbers.
     */
